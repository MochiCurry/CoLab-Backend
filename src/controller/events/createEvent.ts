...
//     const collaborators = Array.isArray(collaborator_preview)
//     ? collaborator_preview.map((c: any) => ({
//         userId: c.user_id,
//         username: c.username,
//         profileImageUrl: c.profile_image_url ?? null,
//       }))
//     : [];
//     const required_items = Array.isArray(data.required_items) ? data.required_items : [];
//     const optional_items = Array.isArray(data.optional_items) ? data.optional_items : [];
...
//     // 🔹 Write to each user's Collaborations (no sensitive fields)
//     const users = [
//       {
//         userId: owner_id,
//         username: host.username,
...
//         status: "accepted",
//       },
//       ...collaborators.map((c: CollaboratorModel) => ({
//         ...c,
//         role: "member",
//         status: "pending",
//       })),
...
//     console.log("🚩 Looping over users:", JSON.stringify(users, null, 2));
  
//     for (const [index, user] of users.entries()) {
//       console.log(`🔁 [Index ${index}] Loop start`, user);
  
//       try {
//         const { userId, username, profileImageUrl = null } = user;
    
//         if (!userId || typeof userId !== "string" || userId.trim() === "") {
//           console.error(`❌ [Index ${index}] Skipping invalid userId:`, userId, user);
//           continue;
//         }
    
//         if (!username || typeof username !== "string") {
//           console.error(`❌ [Index ${index}] Missing username:`, user);
//           continue;
//         }
    
//         console.log(`✅ [Index ${index}] Writing collaborator for:`, userId);
...
//       } catch (err) {
//         console.error(`🔥 [Index ${index}] Failed to process user entry:`, user, err);
//       }
//     }
