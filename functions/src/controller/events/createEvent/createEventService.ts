...
import { Visibility, EventRecord, EventCollaboratorRecord, UserCollaborationRecord, HostModel, FirestoreEventTimeRange } from "@/models/firestore/EventRecord";
...
// Writes the main event and returns the object that was written
export function writeMainEvent(
  ...
  export function writeUserSubcollections(
    ...
    enqueueCollaborationWrites(batch, eventData, users); // writes both sides
  }
